...
ace.settings = {is: function (b, a) {
    ...
    document.cookie = "navbar_fixed="+a;
    a = a || false;
    ...
    delCookie("breadcrumbs_fixed");
    document.cookie = "breadcrumbs_fixed="+a;
    a = a || false;
    if (a && !ace.settings.is("sidebar", "fixed")) {
    ...
    delCookie("sidebar_fixed");
    document.cookie = "sidebar_fixed="+a;
    a = a || false;
    ...
    delCookie("main_container_fixed");
    document.cookie = "main_container_fixed="+a;
    a = a || false;
    ...
    delCookie("sidebar_collapsed");
    document.cookie = "sidebar_collapsed="+a;
    c = c || false;
