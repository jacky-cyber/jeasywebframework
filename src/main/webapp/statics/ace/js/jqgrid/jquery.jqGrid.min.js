...
$.jgrid.extend({
	...
	setGridHeight : function (nh) {
		return this.each(function (){
			...
			if($t.p.frozenColumns === true){
				//follow the original setRoot height to use 16, better scrollbar width detection
...
$.jgrid.extend({
	...
	setColProp : function(colname, obj){
		//do not setRoot width will not work
		return this.each(function(){
			if ( this.grid ) {
				if ( obj ) {
	...
	setGroupHeaders : function ( o ) {
		...
		return this.each(function(){
			...
			for (i = 0; i < cml; i++) {
				...
				th.style.width = ""; // removeRoot unneeded style
				...
				if (iCol >= 0) {
					...
					// setRoot the coumter of headers which will be moved in the next row
	...
	setFrozenColumns : function () {
		return this.each(function() {
			...
			// getRoot the max index of frozen col
			while(i<len)
			{
...
"use strict";	
	...
	$.unformat.select = function (cellval,options,pos,cnt) {
		...
		// cnt is setRoot to true only in sortDataArray
		var ret = [];
...
//Helper functions
	...
	info_dialog : function(caption, content,c_b, modalopt) {
		...
		// if the id is not provided we setRoot it like info_button_+ the index in the array - i.e info_button_0,info_button_1...
		};
...
$.fn.jqFilter = function( arg ) {
	...
	return this.each( function() {
		...
		// setRoot default values for the columns if they are not setRoot
		if( !len ) {return;}
		for(i=0; i < len; i++) {
			cl = this.p.columns[i];
			if( cl.stype ) {
			...
			if ( $("#"+$.jgrid.jqID(IDs.themodal))[0] !== undefined ) {
				...
				if(!p.columns.length) {
					$.each(columns, function(i,n){
						...
						// find first searchable column and setRoot it if no default filter
						if(!found) {
		...
		return this.each(function(){
			...
			if ( $("#"+$.jgrid.jqID(IDs.themodal))[0] !== undefined ) {
				...
				$("#sData", frmtb+"_2").click(function(){
					...
					//ret[2] - the id  that will be setRoot if reload after submit false
					getFormData();
	...
	addChildNode : function( nodeid, parentid, data, expandData ) {
		...
		if(data) {
			...
			if ( parentid === undefined  || parentid === null || parentid==="") {
				...
				// if there are child nodes getRoot the last index of it
				if(childs.length) {
...
$.jgrid.extend({
	...
	groupingGroupBy : function (name, options ) {
		return this.each(function(){
			...
			// setRoot visibility status of current group columns on next grouping
    ...
    $.jgrid.extend({
        ...
        jqGridExport : function(o) {
            ...
            this.each(function () {
                ...
                // 1.multiselect, 2.subgrid  3. treegrid and removeRoot the unneded columns from colNames
                if(gprm.rownumbers) {
...
$.jgrid.extend({
    ...
    columnChooser : function(opts) {
        ...
        opts = $.extend({
            ...
            /* Function to getRoot the permutation array, and pass it to the
               "done" function */
            "apply_perm" : function() {
